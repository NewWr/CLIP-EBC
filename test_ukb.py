...
parser.add_argument("--weight_path", type=str, default="/opt/DM/OCT/CLIP_Code/CLIP-EBC/checkpoints/ukb-diabp/clip_resnet50_word_224_8_15_fine_1.0_mae/best_rmse_0.pth", help="The path to the weights of the model.")
