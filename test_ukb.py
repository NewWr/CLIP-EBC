...
parser.add_argument("--model", type=str, default="clip_convnext_b", help="The model to test.")
...
parser.add_argument("--weight_path", type=str, default="/opt/DM/OCT/CLIP_Code/CLIP-EBC/checkpoints/ukb/clip_convnext_b_word_224_8_15_fine_1.0_mae/best_rmse_0.pth", help="The pat to the weights of the model.")
...
parser.add_argument('--data_path', default='/opt/DM/OCT/StandardData/preprocessed_images/', type=str,
                        help='dataset path')
parser.add_argument('--excel_path', default='/opt/DM/OCT/StandardData/metadata/ukb_test_set.xlsx', type=str,
...
parser.add_argument("--batch_size", type=int, default=1, help="The batch size for evaluation.")
